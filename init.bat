...
pause
git clone https://github.com/hgabor47/bms_inputcontroller.git
git clone https://github.com/hgabor47/bms_imagebuffer.git
git clone https://github.com/hgabor47/bms_screencontentexporter.git
git clone https://github.com/hgabor47/bms_windowslist.git
